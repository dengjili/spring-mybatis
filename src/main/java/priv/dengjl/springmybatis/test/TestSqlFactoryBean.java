...
public class TestSqlFactoryBean {
	
	private static final Logger logger = LoggerFactory.getLogger(TestSqlFactoryBean.class);
	
	public static void main(String[] args) {
		ApplicationContext context = new ClassPathXmlApplicationContext("spring-mybaties2.xml");
